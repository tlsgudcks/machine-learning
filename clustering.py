...
def main():
    ...
    wine_data_set = wine.data
    for i in range(5,len(wine_target),5):
        wine_data.append([wine_data_set[i][0],wine_data_set[i][1],wine_data_set[i][2],wine_target[i]])
    print(wine_data)
    inputs: List[List[float]] = [wine_data]
